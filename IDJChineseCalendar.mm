...
- (id)initWithYearStart:(NSUInteger)start end:(NSUInteger)end displayDate:(NSDate *)displayDete{
    self=[super initWithYearStart:start end:end displayDate:displayDete];
    if (self) {
...
- (NSMutableArray *)monthsInYear:(NSUInteger)_year {
    int monthCounts=ChineseCalendarDB::GetYearMonths((int)_year);
...
- (NSMutableArray *)daysInMonth:(NSString *)_month year:(NSUInteger)_year {
    ...
    int month_=(int)[IDJCalendarUtil monthFromMineToCppWithYear:_year month:_month];
    int dayCounts=ChineseCalendarDB::GetMonthDays((int)_year, month_);
